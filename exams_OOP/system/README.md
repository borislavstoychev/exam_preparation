...
Structure (Problem 1) and Functionality (Problem 2)***](https://github.com/borislavstoychev/exam_preparation/tree/main/exams_OOP/system/project)
...
### Methods
```__init__(name:str, type:str, capacity_consumption:int, memory_consmption:int)```
